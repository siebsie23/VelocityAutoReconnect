...
## Installation
1. Download [the latest release](https://github.com/siebsie23/VelocityAutoReconnect/releases).
...
**log.informational**
* Default: true
* Description: Whether to enable informational log messages, such as the messages printed upon reconnecting a player.
